...
{
    public class TeamPosGenericService<T> : IGenericService<T, TeamPositionBaseModel, int>
        where T : TeamPositionBaseModel
    {
        private readonly FootballDbContext dbContext;

        public TeamPosGenericService(FootballDbContext dbContext)
        {
